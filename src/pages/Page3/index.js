...
const Page3 = ({ title, onPress, navigation }) => {
  ...
  return (
    ...
    <View style={styles.page}>
        ...
        <View style={styles.pesananAktif}>
          <Page title="Toefl" post="Muhammad Nurkhaliz" kategori="Novel" karya="Pramudya Ananta Noer" type="Ada" aksi='Ambil' jenis='Jual' Lokasi='Bandung' Alamat='Jl. Burangrang'/>
        </View>
        <View style={styles.header1}>
          <Text style={styles.kotak2}>Rp 12.000</Text>
          <TouchableOpacity>
