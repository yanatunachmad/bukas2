...
const Page1 = ({ title, onPress, navigation }) => {
  ...
  return (
    ...
    <View style={styles.page}>
        ...
        <View style={styles.pesananAktif}>
          <Page title="Bumi Manusia" post="Muhammad Nurkhaliz" kategori="Novel" karya="Pramudya Ananta Noer" type="Ada" aksi='Ambil' jenis='Hibah' Lokasi='Bandung' Alamat='Jl. Burangrang'/>
        </View>
